...
if (isset($_POST['submit'])) {
    ...
    if ($something_missing == 0) {
        ...
        header("Location: for_business_submit.html");
        exit();
    }
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="for_business_style.css">
...
<body>
    ...
    <header class="top-bar">
        ...
        <a href="../../pages/profile.html" class="account-btn">
    ...
    <div class="app-layout">
        <nav class="side-nav">
            ...
            <a class="nav-item active" href="../../pages/for_business/for_business.html">For Businesses</a>
        ...
        <main class="main-content">
            ...
            <section class="form-section">
                ...
                <form id="partnershipForm" class="partnership-form" action="for_business_form.php" method="post" enctype="multipart/form-data">
